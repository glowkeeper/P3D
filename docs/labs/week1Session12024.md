...
You are required to use GitHub for this module. Besides, GitHub is a great place to save and share your work! Furthermore, version control is a crucial software industry tool, so it's a great skill to learn.
