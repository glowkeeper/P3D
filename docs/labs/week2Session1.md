# Lab for Week 2, Session 1 - Surface Normals and Anti-aliasing

This lab builds on the [previous lab](./week1Session2.md) by turning the circle produced there, into a sphere.
...
### A Sphere with Surface Normal

You are now in a position to amend `main.cpp` so that it creates a sphere juxtaposed against its surface normal.
...
Now you can amend `main.cpp` to include the new camera and `write_color` function.
